...
#define ANALOG_CUTOFF 0 //150 // cut off lower and upper end to avoid un-symmetric joystick range in trade off of resolution
...
const float WARNING_VOLTAGE = 7.0; // 2S Lipo 3.7v per cell
const float BEEPING_VOLTAGE = 6.4; // 2S Lipo 3.5v per cell
...
#define SETTING_1_PktRate 2 // 500Hz
#define SETTING_1_Power 5   // 25mW

#define SETTING_2_PktRate 9 // 50Hz 
#define SETTING_2_Power 4   // 100mW
// ELRS 3.X: 
//------------------------------------------------------------------------------------------------------------------------
//  1 : Set Lua [Packet Rate]= 0 - 50Hz / 1 - 100Hz Full / 2- 150Hz / 3 - 250Hz / 4 - 333Hz Full / 5 - 500Hz / 6 - D250Hz / 7 - D500Hz / 8 - F500Hz
